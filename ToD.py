...
def menu():
    ...
    dare = ['For a guy, put on makeup. For a girl, wash off your make up.','Dance with no music for 1 minute.','Let the group pose you in an embarrassing position and take a picture.','Give the person opposite you your phone and let them send one text to anyone in your contacts.','Lick the floor.','Drink a small cup of a concoction that the group makes.','Sniff the armpits of everyone in the room.','Kiss the person to your left.','Do push ups until you can’t do any more, wait 5 seconds, and then do one more.','Sell a piece of utter trash to someone in the group. Use your best salesmanship.','Switch clothes with someone of the opposite sex in the group for three rounds.','Stick your arm into the trash can past your elbow.','Call an unknown number and tell that person you know where the Chamber of Secrets is.',"Call up a hotel/restaurant and ask if they serve dinosaurs. Also, mention other foods you'd like with the dinosaur.",'Open a bra clasp using your mouth','Prank the local news station and tell them that you’ve seen a giant panda in the forest.','Give someone a piggyback until its yourn turn again.']
    while running == True:
        print('''
1 - Play Game
2 - Add Truths
